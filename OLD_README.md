...
- `enable_anonymous_sign_ins = true` - Allows clients to generate JWT tokens without signing in using an email/password or OAuth provider. The `./flutter_app` project is configured to sign users in **anonymously**.
